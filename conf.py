...
BLOG_AUTHOR = "Mango"  # (translatable)
BLOG_TITLE = "MJ Space"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://minewang.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "mango79314@gmail.com"
BLOG_DESCRIPTION = "我的個人部落格,分享與記錄一些我在開發上遇到的問題"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
       ...
       ('https://github.com/minewang', 'My Github', 'icon-github'),
    ),
}
